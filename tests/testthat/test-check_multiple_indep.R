testthat::test_that("check_multiple_indep", {
  ...
  testthat::expect_no_error(
    object = saros.contents:::check_multiple_indep(data, a)
  )

  # Test 2: Two columns provided for 'indep', expect an error
  testthat::expect_error(
    object = saros.contents:::check_multiple_indep(data, c(a, b)),
  ...
  testthat::expect_no_error(
    object = saros.contents:::check_multiple_indep(data_no_col, NULL)
  )

  # Test 4: Select no column, expect no error
  testthat::expect_no_error(
    object = saros.contents:::check_multiple_indep(data, NULL))
