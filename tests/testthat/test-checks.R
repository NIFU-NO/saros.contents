testthat::test_that("check_bool", {
  ...
  testthat::expect_error(
    object = saros.contents:::check_bool(test_arg),
...
testthat::test_that("check_integerish", {
  ...
  test_arg <- "d"
  testthat::expect_error(
    object = saros.contents:::check_integerish(test_arg),
  ...
  test_arg <- -2
  testthat::expect_error(
    object = saros.contents:::check_integerish(test_arg, min = 0),
  ...
  test_arg <- 10
  testthat::expect_error(
    object = saros.contents:::check_integerish(test_arg, min = 0, max = 8),
...
testthat::test_that("check_double", {
  test_arg <- "d"
  testthat::expect_error(
    object = saros.contents:::check_double(test_arg),
    regexp = "`test_arg` must be a numeric of length 1, not a string"
  )

  test_arg <- -2.5
  testthat::expect_error(
    object = saros.contents:::check_double(test_arg, min = 0),
