testthat::test_that("simple_descriptives works with numeric y_var without x_var", {
  ...
  result <- saros.contents:::simple_descriptives(data = data, y_var = "y_var")
...
testthat::test_that("simple_descriptives works with numeric y_var and x_var", {
  ...
  result <- saros.contents:::simple_descriptives(data = data, y_var = "y_var", x_var = "x_var")
  testthat::expect_true(is.data.frame(result))
...
testthat::test_that("simple_descriptives removes NA in x_var if na.rm = TRUE", {
  ...
  result <- saros.contents:::simple_descriptives(data = data, y_var = "y_var", x_var = "x_var", na.rm = TRUE)
  testthat::expect_true(is.data.frame(result))
  testthat::expect_true(ncol(result)==7)
})

testthat::test_that("simple_descriptives does not remove NA in x_var if na.rm = FALSE", {
  data <- data.frame(y_var = c(1, 2, 3, 4, 5), x_var = c("A", NA, "B", "B", "B"))
  result <- saros.contents:::simple_descriptives(data = data, y_var = "y_var", x_var = "x_var", na.rm = FALSE)
  testthat::expect_true(is.data.frame(result))
  testthat::expect_true(ncol(result)==7)
  testthat::expect_true(nrow(result)==3)
})
...
testthat::test_that("simple_descriptives returns data frame if y_var is categorical", {
  ...
  result <- saros.contents:::simple_descriptives(data = data, y_var = "y_var", x_var = "x_var", table_wide = F)
  testthat::expect_true(is.data.frame(result))
...
testthat::test_that("simple_descriptives handles single row input", {
  ...
  result <- saros.contents:::simple_descriptives(data = data, y_var = "y_var")
  testthat::expect_true(is.data.frame(result))
  testthat::expect_true(result$mean==1)
})
testthat::test_that("simple_descriptives handles single row input", {
...
testthat::test_that("simple_descriptives handles missing y_var gracefully", {
  ...
  testthat::expect_error(saros.contents:::simple_descriptives(data = data, y_var = "y_var", x_var = "x_var"))
})
